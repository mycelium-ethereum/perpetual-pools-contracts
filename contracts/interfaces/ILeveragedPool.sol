...
interface ILeveragedPool {
  ...
  // maxImbalance = percent desired * (2^64)
  struct Commit {
    uint256 created;
    uint256 amount;
    int128 maxImbalance; // Must be the same format as ABDKMath 64.64 fixed point.
    address owner;
 ...
 */
  ...
  /**
    ...
    @param ratio The ratio to calculate. This should be a ABDKMath 64x64 fixed point number. Use the getRatio function to calculate this
