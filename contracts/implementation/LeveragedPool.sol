...
contract LeveragedPool is ILeveragedPool, Initializable, IPausable {
    ...
    // #### Modifiers
    /**
     * @dev Check invariants before function body only. This is used in functions where the state of the pool is updated after exiting LeveragedPool (i.e. executeCommitments)
     */
